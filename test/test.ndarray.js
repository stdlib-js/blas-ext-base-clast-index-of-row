...
tape( 'the function has an arity of 12', function test( t ) {
	t.strictEqual( clastIndexOfRow.length, 12, 'returns expected value' );
	t.end();
});
...
tape( 'the function returns an invalid index when M is less than or equal to zero (row-major)', function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = clastIndexOfRow( 0, data.N, new Complex64Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex64Array( data.x ), data.strideX, data.offsetX, new Uint8Array( data.M ), 1, 0 );
...
tape( 'the function returns an invalid index when N is less than or equal to zero (row-major)', function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = clastIndexOfRow( data.M, 0, new Complex64Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex64Array( data.x ), data.strideX, data.offsetX, new Uint8Array( data.M ), 1, 0 );
...
tape( 'the function returns the index of the last row matching a search vector (row-major)', function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = clastIndexOfRow( data.M, data.N, new Complex64Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex64Array( data.x ), data.strideX, data.offsetX, new Uint8Array( data.M ), 1, 0 );
